...
\caption{(ref:goApopttree)}(\#fig:goApopttree)
\end{figure}
...
\caption{(ref:keggCellCyclePathw)}(\#fig:keggCellCyclePathw)
\end{figure}
...
\caption{(ref:biocartaCorticosPathw)}(\#fig:biocartaCorticosPathw)
\end{figure}
...
\caption{(ref:reactomeApoptPathw)}(\#fig:reactomeApoptPathw)
\end{figure}
...
\caption{(ref:diagramaORA)}(\#fig:diagramaORA)
\end{figure}
...
\caption{(ref:diagramaFCS)}(\#fig:diagramaFCS)
\end{figure}
